                                ...
                                <div className='p-1'>
                                    ...
                                    <div className='relative p-3 border-t'>
                                        ...
                                        <div className='mt-4 flex items-center justify-between text-text'>
                                            ...
                                            <button onClick={()=>{addProduct(product._id)}} type="button" className="inline-flex items-center gap-1.5 rounded-lg border border-primary bg-white px-3.5 py-1.5 text-center text-sm font-medium text-gray-700 shadow-sm transition-all focus:ring focus:ring-gray-100 hover:border-primary hover:bg-primary hover:text-white">
                                                Add
